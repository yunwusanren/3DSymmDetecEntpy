...
extern void mesh_cpca_covariance(TriMesh *mesh, float C[3][3]);

extern void mesh_cpca_part_covariance(TriMesh *mesh, int axis, float C[3][3],float C_[3][3]);
	
// Compute npca covariance of faces (integral area-weighted) in a mesh
extern void mesh_npca_covariance(TriMesh *mesh, float C[3][3]);
